...
import WeeklyHRZonesChartCopy from "../components/charts/WeeklyHRZonesChartCopy";
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          {/* HR Zones Section - IMPROVED VERSION */}
          {filteredWeeklyHRZones.length > 0 && (
            <WeeklyHRZonesChartCopy
              data={filteredWeeklyHRZones}
              title="HR Zones"
              showHeader={true}
              helpTooltip={hrZoneHelpContent}
            />
          )}
