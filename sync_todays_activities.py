#!/usr/bin/env python
"""Sync today's activities using the full ingestion and enrichment service"""
import os
import sys
...
def main():
    ...
    try:
        ...
        if not result:
            print("❌ No activities found in database. You may need to connect Strava first.")
            return
        ...
        print("This will sync today's activities from Strava and enrich them with additional data.")
