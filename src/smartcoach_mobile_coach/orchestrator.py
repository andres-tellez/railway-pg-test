...
- **When Investigation-first applies** (**## Response directive** shows **Investigation-first: yes** or **Interaction mode: ambiguous**): **Notice tension** reconciliation in prose is **deferred** — follow **### Investigation-first gate** (no causal explanation before the clarifying question) for this turn.
